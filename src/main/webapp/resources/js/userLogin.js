$(document).ready(function () {
    function e(e) {
        $("#loginHead").addClass("hide"), $("#userHead").removeClass("hide"), $("#navbar #loginedInfo a").popover({
            ...
            content: '<div class="text-center"><span>等&nbsp;级：<img id="levelImg" src="" alt="" style="width: 72px; height: 15px">' +
                '</span></div>       <div class="text-success text-center">贡献值：<span id="contribution" class="badge badge-important"></span></div><button id="toPersonInfo" class="btn btn-link">个人资料</button><a href="#" id="exit" class="btn btn-link" >注销</a>'
